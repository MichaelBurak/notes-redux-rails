...
Note.create(title: 'Notes!', body: 'A note app! Try it out!', liked: false)
Note.create(title: "CRUDdy app!", body: 'Enjoy that you can delete your mistakes and change your mind too!', liked: true )
