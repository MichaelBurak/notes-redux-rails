// Displays a single note as well as the container to edit said note and a button
// to delete said note.
...
class Note extends React.Component {
  ...
  // delete function, prevents default submission of form. pulls in history prop
  // through withRouter despite not being directly on route. pulls in id through
  // passed down prop from corresponding show container. calls action with
  // appropriate id to delete appropriate note and push to page with deleted note
  // info.
  ...
  render() {
    return (
      <div>
        ...
        <Button type='button' onClick={(e) => this.delete(e)}>Delete Note</Button>
        <br/>
        <br/>
        <br/>
        <EditNoteContainer
